...
@section('content')
    <style>
        ...
        .cards-container {
            ...
            flex-wrap: wrap;
            /* Ahora permitimos que las tarjetas se envuelvan */
        }
        ...
        .card {
            ...
            flex-grow: 1;
            /* Para que las tarjetas ocupen el mismo espacio */
        }
        ...
        @foreach ($clientes as $index => $cliente)
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <br>
                <center><h4>{{ $cliente->phone }}</h4></center>
                    <a href="{{ route('cliente.show', $cliente->id) }}" class="btn btn-primary">Compras</a>
                </div>
            </div>
        @endforeach
    </div>
